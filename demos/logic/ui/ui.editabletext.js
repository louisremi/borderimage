/*
 * jQuery UI texteditable @VERSION
 *
 * Copyright (c) 2008 lrbabe
...
$.widget("ui.editabletext", {
	...
	_init: function() {
		var el = this.element;
		el.wrap('<iframe style="position:absolute"></iframe>').parent()[0].contentWindow.document.designMode = "on";
...
/*
$.ui.editablo.getter = "value";

$.ui.editablo.defaults = {
