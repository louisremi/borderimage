...
$.widget("ui.resizable", $.extend({}, $.ui.mouse, {
	_init: function() {
		...
		// Knob Theme
		knobPosition = o.externalKnob? '-10px' : '0px';
		...
		o.knobTheme = {
			...
			'ui-resizable-n': { cursor: 'n-resize', top: knobPosition, left: '45%' },
			'ui-resizable-s': { cursor: 's-resize', bottom: knobPosition, left: '45%' },
			'ui-resizable-e': { cursor: 'e-resize', right: knobPosition, top: '45%' },
			'ui-resizable-w': { cursor: 'w-resize', left: knobPosition, top: '45%' },
			'ui-resizable-se': { cursor: 'se-resize', right: knobPosition, bottom: knobPosition },
			'ui-resizable-sw': { cursor: 'sw-resize', left: knobPosition, bottom: knobPosition },
			'ui-resizable-nw': { cursor: 'nw-resize', left: knobPosition, top: knobPosition },
			'ui-resizable-ne': { cursor: 'ne-resize', right: knobPosition, top: knobPosition }
		};
